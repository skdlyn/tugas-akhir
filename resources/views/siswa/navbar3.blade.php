...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #15477A">
    <div class="brand">
        <img src="{{asset('asset/img/logonew.png')}}" width="50%">
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto topnav">
            ...
            <li class="nav-item">
                <a class="nav-link btn btn-primary text-white" type="button" href="#" data-toggle="modal" data-target="#myModal">
                    Sign In
                </a>                  
            </li>
